...
num_genes = 5  # Dimension of the problem
maxGeneValue = 200 # Number of generations
sol_per_pop = 50  # Population size
gene_space = [{'low': -10, 'high': 10} for _ in range(num_genes)]
initial_population = np.random.uniform(low=1, high=5, size=(sol_per_pop, num_genes))
...
ga_instance = pygad.GA(
    ...
    mutation_probability = 0.01, # Mutation probability, 0.01 means 1% chance of mutation
    # mutation_percent_genes = 1, # Mutation probability in percentage format (1%)
    # random_seed = 5, # Random seed for reproducibility
